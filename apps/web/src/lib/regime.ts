...
const REGIMES_AR: Record<RegimeId, RegimeInfo> = {
  declaration: {
    ...
    title: 'نظام التصريح',
    summary:
      'تركيبات أقل من 11 kW موصولة بالجهد المنخفض، أو تركيبات غير موصولة بالشبكة (مواقع معزولة). يكفي تصريح مسبق.',
    obligations: [
  ...
  accord: {
    ...
    summary:
      'تركيبات موصولة بالشبكة، من عتبة التصريح إلى غاية 5 MW، بالجهد المنخفض أو المتوسط. يلزم اتفاق ربط مع مدبّر الشبكة قبل وضعها قيد الخدمة.',
    obligations: [
  ...
  autorisation: {
    ...
    title: 'نظام الترخيص',
    summary:
      'تركيبات تبلغ 5 MW فما فوق، موصولة بالجهد المتوسط أو العالي أو العالي جداً. يُشترط ترخيص مسبق.',
    obligations: [
