...
|---|---|---|
| 0 – 100 kWh | 0,916272 | progressif |
| 101 – 150 kWh | 1,091388 | progressif |
| 151 – 210 kWh | 1,091388 | **sélectif** |
| 211 – 310 kWh | 1,187388 | **sélectif** |
| 311 – 510 kWh | 1,405116 | **sélectif** |
| > 510 kWh | 1,622856 | **sélectif** |
...
**Exemple concret :** un foyer qui consomme 250 kWh en juillet ne paie pas les 100 premiers kWh à 0,916272 DH puis les suivants à 1,091388… Il paie les 250 kWh *entiers* au tarif de la tranche 211–310 kWh, soit 1,187388 DH/kWh (une tolérance de 10 kWh par tranche atténue les dépassements de justesse).

Ce que le solaire supprime, c'est précisément ce tarif marginal élevé appliqué à la totalité de la facture. Prenez un foyer en tranche 311–510 kWh qui retire 200 kWh par mois du réseau grâce à ses panneaux : il économise ces 200 kWh au tarif *marginal* de 1,405116 DH, et non au tarif moyen apparent de son ancienne facture. C'est toute la raison pour laquelle la rentabilité grimpe chez les gros consommateurs, et c'est aussi ce que je vérifie en premier sur une facture avant de chiffrer quoi que ce soit.
...
- **Votre tranche tarifaire actuelle** : plus vous êtes en tranche haute (≥ 1,405116 DH/kWh), plus les économies annuelles sont grandes et le retour rapide.
