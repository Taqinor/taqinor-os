...
class Ntapi20OpenApiSchemaTests(TestCase):
    ...
    def test_covers_every_read_only_resource_list_and_detail(self):
        ...
        # Procure-to-Pay (`lecture_achats`) ; CAL214 ajoute `public-calepinage`
        # (les conceptions de toiture, `read:calepinages`), pour 17 au total :
        # on fige l'ENSEMBLE exact (plus fort qu'un simple compte), donc un
        # 18ᵉ enregistrement resterait un choix délibéré, pas un accident.
    ...
    def test_no_undocumented_paths_beyond_mounted_surface(self):
        ...
        self.assertEqual(nb_operations, 50)
