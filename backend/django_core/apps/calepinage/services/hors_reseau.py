...
__all__ = ['HorsReseauInvalide', 'banque_pour_autonomie',
           'dimensionner_hors_reseau', 'simuler_hors_reseau']
...
def simuler_hors_reseau(charge_horaire, production_horaire, *,
    ...
    Raises:
        HorsReseauInvalide: courbes absentes, de longueurs différentes, ou
            capacité inconnue.
    """
