# QJ28 — nouvel événement « devis_superior_contact_requested » (un vendeur
# demande l'avis de son supérieur sur un devis). Additif : seul le jeu de
# choices des colonnes event_type change (aucune donnée touchée).
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('notifications', '0011_qj27_client_contact_request'),
    ]
