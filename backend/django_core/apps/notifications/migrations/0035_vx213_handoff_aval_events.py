# VX213 — handoffs AVAL : 3 nouveaux EventTypes (chantier assigné, DA décidée,
# DA soumise en attente/SLA). AlterField des choices — additif, aucun DDL
# destructif (choices ne touchent pas le schéma DB, max_length inchangé à 40).
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('notifications', '0034_alter_notification_event_type_and_more'),
    ]
