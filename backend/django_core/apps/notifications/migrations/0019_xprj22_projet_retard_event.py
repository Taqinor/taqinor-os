# XPRJ22 — nouvel événement « projet_retard » (retard/risque de planning sur
# un projet, gestion_projet). Additif : seul le jeu de choices des colonnes
# event_type change (aucune donnée touchée).
