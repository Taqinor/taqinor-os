"""NTOBS9 — ajoute l'événement 'maintenance_window_announced' à ``EventType``.
...
0054_eventtype_export_reversibilite_pret)."""
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('notifications', '0054_eventtype_export_reversibilite_pret'),
    ]
