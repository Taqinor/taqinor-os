...
BASELINE_ALLOWLIST = {
    ...
    # PUB96 (2026-07-19) — +6 lines above them from the CGNC 6144 advertising
    # account added to _COMPTES_CGNC; same NPS/ROI/percentage sites, unmoved
    # logic, verified uniform +6 shift, NOT new sites — bug-class #34.
