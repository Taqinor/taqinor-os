...
DATEFIELD_AUTO_NOW_ALLOWLIST = {
    ...
    "backend/django_core/apps/facturation/models.py:912",
    "backend/django_core/apps/facturation/models.py:1099",
...
TIMESTAMP_AS_DATEFIELD_ALLOWLIST = {
    ...
    "backend/django_core/apps/crm/models.py:2497",  # CommissionPartenaire.paye_le
    ...
    "backend/django_core/apps/adsengine/models.py:2602",  # ConsentRecord.date_consentement
}
