...
/* Collecte EAGER de toutes les configs de module (données + composants lazy).
   ...
   SOLMVP3 — un seul produit : plus de glob conditionnel par édition. Un module
   qui sort du périmètre sort PHYSIQUEMENT du dépôt (son dossier
   `features/<x>/` disparaît), donc le glob ne le voit plus — il n'y a rien à
   filtrer. */
const configModules = import.meta.glob(
  '../features/*/module.config.jsx', { eager: true })
