...
import {
  ...
  Leaf, DatabaseBackup, HardDriveDownload, Gauge,
} from 'lucide-react'
...
// ModuleToggle (`moduleLoader`) ni l'édition ne pouvaient les retirer, et le
// module `parametres` (fondation) importait `pages/mrp/*`. Le chemin
// `/parametres/mrp` est INCHANGÉ.
