...
vi.mock('../../api/flotteApi', () => {
  ...
  return {
    default: {
      vehicules: crud, engins: crud, referentiels: crud, actifs: crud,
      conducteurs: crud, affectations: crud, reservations: crud,
      demandesVehicule: crud, etatsDesLieux: crud,
      plansEntretien: crud, echeancesEntretien: crud, garages: crud,
      ordresReparation: crud, pneumatiques: crud, pieces: crud,
      echeancesReglementaires: crud, assurances: crud, visitesTechniques: crud,
      cartesGrises: crud, baremesVignette: crud,
      pleins: crud, cartes: crud, sinistres: crud, infractions: crud,
