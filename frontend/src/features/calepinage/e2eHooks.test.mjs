...
export const ALL_HOOKS = [
  ...
  // Bibliotheque.jsx
  'cal-biblio-marquer',
  'cal-biblio-marquer-bouton',
  'cal-biblio-marquer-erreur',
  'cal-biblio-marquer-id',
  // CalepinageList.jsx
  'cal-barre-comparaison',
  'cal-comparer',
  'cal-mode-comparer',
  'cal-ouvrir-comparaison',
  // CalepinageNouveau.jsx
  'cal-nouveau-jeux-vide',
  'cal-nouveau-modele-apercu',
  'cal-nouveau-modeles-vide',
  // ComparaisonProjets.jsx
  'cal-comparaison',
  'cal-comparaison-classeur',
  'cal-comparaison-motif',
  'cal-comparaison-motif-classeur',
  'cal-comparaison-refus',
  // Etiquettes.jsx
  'cal-etiquettes',
  'cal-etiquettes-ajouter',
  'cal-etiquettes-choix',
  'cal-etiquettes-erreur',
  'cal-etiquettes-proposer',
  'cal-filtre-etiquettes',
  'cal-filtre-etiquettes-choix',
  'cal-filtre-etiquettes-option',
