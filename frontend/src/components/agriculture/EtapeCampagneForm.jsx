...
/* ============================================================================
   ...
   client, re-vérifié côté serveur à l'enregistrement). La fonction miroir
   `checkDarAlert` vit dans `features/agriculture/darAlert.js` : ce fichier
   n'exporte que le composant (react-refresh/only-export-components).
   ========================================================================== */
