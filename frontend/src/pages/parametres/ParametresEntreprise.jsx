...
const cardStyle = { background: '#fff', borderRadius: 14, border: '1px solid #e2e8f0', padding: '1.25rem 1.4rem' }
...
export default function ParametresEntreprise() {
  ...
  // ── Cartes réutilisables (référentiels CRM/chantier/stock) ────────────────────
  const cardTagsMotifs = (
    <div style={cardStyle}>
