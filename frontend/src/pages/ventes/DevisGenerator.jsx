...
export default function DevisGenerator({
  ...
  // ── Lignes ──
  // VX188 — callbacks stabilisés (identité stable via useCallback, clé de
  // ligne en ARGUMENT) : seule une dépendance RÉELLEMENT utilisée (lines,
  // produits, clientId, canRenameLine…) change leur identité — jamais un
  // état sans rapport comme « Note ». C'est ce qui permet à
  // `React.memo(DevisLineRow)` de sauter le re-rendu d'une ligne inchangée.
