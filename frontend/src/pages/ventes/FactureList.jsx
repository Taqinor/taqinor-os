...
export default function FactureList() {
  ...
  // VX249(b) — payMode : 1 des 4 champs VX93 exactement (avec owner/ville sur
  // LeadForm.jsx et tva sur ProduitForm.jsx/DevisGenerator.jsx). « Suggéré »
  // tant que l'utilisateur n'a pas choisi LUI-MÊME un mode pour CE paiement.
      ...
      <Dialog open={!!payTarget} onOpenChange={(o) => { if (!o) setPayTarget(null) }}>
        <DialogContent>
          ...
          <Form onSubmit={handleEnregistrerPaiement} className="gap-4">
            ...
            {/* VX249(b) — payMode : 1 des 4 champs VX93 exactement. Contour
                pointillé + micro-libellé au focus tant que le dernier mode
            ...
            >
              <Select
                value={payMode}
                onValueChange={(v) => { setPayMode(v); setPayModeTouched(true) }}
              >
                <SelectTrigger
                  id="pay-mode"
