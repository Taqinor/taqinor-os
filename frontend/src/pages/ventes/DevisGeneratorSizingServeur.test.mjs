...
// l'écran générateur : sous le seuil du balayage local (`computeAutoSizing`
// → `null`), l'écran attend/affiche la recommandation (ou le refus nommé) du
// moteur horaire SERVEUR au lieu de deviner une taille.
//
