...
- frontend/src/api/aiGovernanceApi.js :: prochainesActions -> /api/django/ai/prochaines-actions
    actions:inconnu, content_type:texte, detail:texte, execute:booleen, faits:inconnu, libelle:inconnu, object_id:inconnu
...
- frontend/src/api/aiGovernanceApi.js :: resumeFiche -> /api/django/ai/resume-fiche
    content_type:texte, detail:texte, entrees_fil:nombre, faits:inconnu, libelle:inconnu, object_id:inconnu, resume:inconnu, source:inconnu
- frontend/src/api/aiGovernanceApi.js :: usage -> /api/django/ai-governance/usage
    cout_complet:booleen, depuis:inconnu, detail:texte, feature:texte, par_feature:inconnu, par_fournisseur:inconnu, par_jour:inconnu, totaux:inconnu
...
- frontend/src/api/contratsApi.js :: getDeviations -> /api/django/contrats/contrats/deviations
    count:nombre, results:inconnu
- frontend/src/api/contratsApi.js :: getDeviationsContrat -> /api/django/contrats/contrats/<>/deviations
    contrat:inconnu, count:nombre, results:inconnu, type_contrat:inconnu
...
- frontend/src/api/contratsApi.js :: getTableauBord -> /api/django/contrats/contrats/tableau-de-bord
    a_renouveler:inconnu, actifs:inconnu, deviations:inconnu, en_risque:inconnu, exceptions_facturation:inconnu, mrr:inconnu, mrr_combine:inconnu, mrr_par_responsable:inconnu, par_statut:inconnu, par_type:inconnu, total:inconnu, valeur_active:inconnu, valeur_totale:inconnu
...
- frontend/src/api/esgApi.js :: badgeMaturite -> /api/django/esg/catalogue-esg/badge-maturite
    composantes:objet, disclaimer:inconnu, ponderation:objet, score:inconnu
...
- frontend/src/api/esgApi.js :: prerequisCloture -> /api/django/esg/periodes-esg/<>/prerequis-cloture
    avertissements:inconnu, bloquants:inconnu, comparaison:inconnu, couverture:inconnu, frequence_reporting:inconnu, periode:objet, peut_figer:booleen
...
- frontend/src/api/juridiqueApi.js :: budget -> /api/django/juridique/dossiers/<>/budget
    budget_alloue:inconnu, consomme:texte, depassement:booleen, dossier:inconnu, engage:texte, pourcentage_consomme:inconnu, reference:inconnu
- frontend/src/api/juridiqueApi.js :: proposerProvision -> /api/django/juridique/dossiers/<>/proposer-provision
    apercu:inconnu, confirme:texte, montant:inconnu, provision_comptable_id:inconnu, reference:inconnu
- frontend/src/api/juridiqueApi.js :: reprendreProvision -> /api/django/juridique/dossiers/<>/reprendre-provision
    confirme:texte, montant:texte, montant_repris:texte, provision_comptable_id:inconnu, provision_reprise:booleen, reprise_provision_traitee:booleen
- frontend/src/api/juridiqueApi.js :: statutsSuivants -> /api/django/juridique/dossiers/<>/statuts-suivants
    statut:inconnu, suivants:liste
- frontend/src/api/juridiqueApi.js :: tableauBord -> /api/django/juridique/dossiers/tableau-bord
    depassements:inconnu, echeances_prescription_30j:inconnu, montant_en_jeu_total:texte, nombre_dossiers:nombre, par_nature:liste, provisions_comptabilisees:inconnu, provisions_proposees:inconnu, total_consomme:texte, total_engage:texte
...
- frontend/src/api/litigesApi.js :: escaladerJuridique -> /api/django/litiges/reclamations/<>/escalader-juridique
    cree:inconnu, detail:texte, dossier_juridique_id:inconnu, reference:inconnu
...
- frontend/src/api/mrpApi.js :: clotureAssisteeOF -> /api/django/mrp/ordres-fabrication/<>/cloture-assistee
    erreurs:inconnu, operations_terminees:inconnu, ordre_fabrication:inconnu
- frontend/src/api/mrpApi.js :: getGenealogieOF -> /api/django/mrp/ordres-fabrication/<>/genealogie
    amont:inconnu, aval:inconnu, of_id:inconnu, produit_id:inconnu
- frontend/src/api/mrpApi.js :: getTableauBordProduction -> /api/django/mrp/tableau-bord
    charge_moyenne_pct:texte, of_en_retard:inconnu, postes_en_alerte_maintenance:inconnu, trs_moyen_pct:texte
- frontend/src/api/mrpApi.js :: simulerCharge -> /api/django/mrp/simuler-charge
    lignes:inconnu, poste_goulot:inconnu, retard_jours:inconnu, tenable:inconnu
...
- frontend/src/api/paieApi.js :: apercuPublicationBareme -> /api/django/paie/baremes/<>/wizard-publication
    bareme:inconnu, etape:texte, impact:inconnu, jeton_apercu:inconnu, periodes_impactees:inconnu, rappel:inconnu
...
- frontend/src/api/paieApi.js :: publierBareme -> /api/django/paie/baremes/<>/wizard-publication
    bareme:inconnu, etape:texte, impact:inconnu, jeton_apercu:inconnu, periodes_impactees:inconnu, rappel:inconnu
...
- frontend/src/api/portailApi.js :: enAttente -> /api/django/portail/satisfaction
    enquete:inconnu
...
- frontend/src/api/portailApi.js :: repondre -> /api/django/portail/satisfaction/repondre
    detail:texte, lien_avis_google:inconnu, score:texte
...
- frontend/src/api/rhApi.js :: getTableauBordOkr -> /api/django/rh/okr-individuels/tableau-de-bord
    entreprise:inconnu, equipe:inconnu, est_manager:booleen, mes_okr:inconnu, periode:texte
...
- frontend/src/api/rhApi.js :: repondrePulse -> /api/django/rh/campagnes-pulse/<>/repondre
    detail:texte
- frontend/src/api/rhApi.js :: validerCalibrationCycle -> /api/django/rh/cycles-revision/<>/valider-calibration
    cycle:inconnu, detail:texte, propositions_figees:nombre, statut:inconnu
...
- frontend/src/api/scmApi.js :: creerBrouillonsBcfReappro -> /api/django/scm/tableau-bord-reappro/creer-bcf
    bons_crees:inconnu
- frontend/src/api/scmApi.js :: creerPolitiquesEnLot -> /api/django/scm/politiques-stock/creer-en-lot
    nb_politiques:nombre, politiques:inconnu, produit_ids:texte, service_level_pct:texte
- frontend/src/api/scmApi.js :: detecterAnomaliesDemande -> /api/django/scm/anomalies-demande/detecter
    nb_flags:nombre
- frontend/src/api/scmApi.js :: impactFinancierCycleSop -> /api/django/scm/cycles-sop/<>/impact-financier
    alerte_ecart:inconnu, ca_forecast_ht:texte, ca_previsionnel_ht:texte, cycle_id:inconnu, detail:texte, ecart_pct:inconnu, lignes:inconnu, periode:inconnu, seuil_alerte_pct:inconnu
- frontend/src/api/scmApi.js :: majParametresSop -> /api/django/scm/parametres-sop
    animateur_sop:inconnu, animateur_sop_nom:inconnu, sop_actif:inconnu
- frontend/src/api/scmApi.js :: parametresSop -> /api/django/scm/parametres-sop
    animateur_sop:inconnu, animateur_sop_nom:inconnu, sop_actif:inconnu
- frontend/src/api/scmApi.js :: precisionPrevisions -> /api/django/scm/precision-previsions
    mape_global_pct:inconnu, nb_mois_couverts:nombre, par_produit:inconnu, produit:texte
...
- frontend/src/api/scmApi.js :: tableauBordExecutif -> /api/django/scm/tableau-bord
...
- frontend/src/api/aiGovernanceApi.js :: budgets -> /api/django/ai-governance/budgets  [LlmBudgetSerializer]
    champs: actif, alerte_periode, created_at, id, montant_mensuel_mad, seuil_alerte_pct, updated_at
- frontend/src/api/aiGovernanceApi.js :: creerBudget -> /api/django/ai-governance/budgets  [LlmBudgetSerializer]
    champs: actif, alerte_periode, created_at, id, montant_mensuel_mad, seuil_alerte_pct, updated_at
- frontend/src/api/aiGovernanceApi.js :: modifierBudget -> /api/django/ai-governance/budgets/<>  [LlmBudgetSerializer]
    champs: actif, alerte_periode, created_at, id, montant_mensuel_mad, seuil_alerte_pct, updated_at
- frontend/src/api/aiGovernanceApi.js :: promptTemplates -> /api/django/ai-governance/prompt-templates  [PromptTemplateSerializer]
    champs: actif, capability, cle, corps, created_at, id, label, placeholders, updated_at, versions
...
- frontend/src/api/automationApi.js :: deleteRule -> /api/django/automation/rules/<>  [AutomationRuleSerializer]
    ...
    trigger_type ∈ {chantier_status, custom_record_saved, date_echeance_champ, devis_accepted, facture_overdue, lead_stage_change, maintenance_due, projet_phase_change, projet_status_change, record_state_change, stock_below_threshold, warranty_expiring, webhook_inbound}
...
- frontend/src/api/contratsApi.js :: createObligation -> /api/django/contrats/obligations  [ObligationSerializer]
    champs: contrat, date_creation, date_echeance, date_realisation, description, id, intitule, jalon, ordre, preuve_document, preuve_document_nom, preuve_manquante, redevable, redevable_display, statut, statut_display
...
- frontend/src/api/installationsApi.js :: updateTransporteur -> /api/django/installations/transporteurs/<>  [TransporteurSerializer]
    champs: active, contact, created_by, date_creation, date_modification, id, nom, note, tarif_base, telephone, type_transporteur, type_transporteur_display
    type_transporteur ∈ {interne, tiers}
- frontend/src/api/juridiqueApi.js :: audiences -> /api/django/juridique/audiences  [AudienceSerializer]
    champs: created_at, date_audience, dossier, heure, id, juridiction_salle, prochaine_echeance, reporte_depuis, resultat, statut, type_audience, updated_at
    statut ∈ {annulee, programmee, reportee, tenue}
    type_audience ∈ {execution, mise_en_etat, plaidoirie, refere}
- frontend/src/api/juridiqueApi.js :: cabinets -> /api/django/juridique/cabinets-avocats  [CabinetAvocatSerializer]
    champs: actif, barreau, contact_principal, created_at, email, id, nom, specialites, taux_horaire_moyen, telephone, updated_at
- frontend/src/api/juridiqueApi.js :: create -> /api/django/juridique/dossiers  [DossierJuridiqueSerializer]
    champs: budget_alloue, confidentialite, created_at, date_ouverture, id, juridiction_degre, juridiction_nom, juridiction_ville, montant_en_jeu, montant_risque_estime, nature, nature_libelle, notre_position, partie_adverse_nom, probabilite_risque, provision_comptable_id, reference, reprise_provision_a_proposer, reprise_provision_proposee, reprise_provision_traitee, responsable_interne, responsable_interne_nom, resume_faits, statut, statut_libelle, titre, type_procedure, updated_at
    confidentialite ∈ {confidentiel, interne, public}
    juridiction_degre ∈ {appel, cassation, premiere_instance}
    nature ∈ {consultatif, contentieux, precontentieux, recouvrement}
    notre_position ∈ {defendeur, demandeur}
    probabilite_risque ∈ {faible, forte, moyenne}
    statut ∈ {appel, audience_programmee, clos_desistement, clos_gagne, clos_perdu, clos_transaction, en_delibere, execution, instruction, jugement_rendu, ouvert}
    type_procedure ∈ {administratif, arbitrage, civil, commercial, penal, social}
- frontend/src/api/juridiqueApi.js :: delaisPrescription -> /api/django/juridique/delais-prescription  [DelaiPrescriptionSerializer]
    champs: alerte_envoyee_le, created_at, date_declenchement, date_limite, dossier, duree_jours, id, jours_restants, statut, type_delai, updated_at
    statut ∈ {en_cours, expire, respecte}
    type_delai ∈ {autre, delai_appel, delai_pourvoi, delai_reponse, prescription_action}
- frontend/src/api/juridiqueApi.js :: get -> /api/django/juridique/dossiers/<>  [DossierJuridiqueSerializer]
    champs: budget_alloue, confidentialite, created_at, date_ouverture, id, juridiction_degre, juridiction_nom, juridiction_ville, montant_en_jeu, montant_risque_estime, nature, nature_libelle, notre_position, partie_adverse_nom, probabilite_risque, provision_comptable_id, reference, reprise_provision_a_proposer, reprise_provision_proposee, reprise_provision_traitee, responsable_interne, responsable_interne_nom, resume_faits, statut, statut_libelle, titre, type_procedure, updated_at
    confidentialite ∈ {confidentiel, interne, public}
    juridiction_degre ∈ {appel, cassation, premiere_instance}
    nature ∈ {consultatif, contentieux, precontentieux, recouvrement}
    ...
    statut ∈ {appel, audience_programmee, clos_desistement, clos_gagne, clos_perdu, clos_transaction, en_delibere, execution, instruction, jugement_rendu, ouvert}
    type_procedure ∈ {administratif, arbitrage, civil, commercial, penal, social}
- frontend/src/api/juridiqueApi.js :: list -> /api/django/juridique/dossiers  [DossierJuridiqueSerializer]
    champs: budget_alloue, confidentialite, created_at, date_ouverture, id, juridiction_degre, juridiction_nom, juridiction_ville, montant_en_jeu, montant_risque_estime, nature, nature_libelle, notre_position, partie_adverse_nom, probabilite_risque, provision_comptable_id, reference, reprise_provision_a_proposer, reprise_provision_proposee, reprise_provision_traitee, responsable_interne, responsable_interne_nom, resume_faits, statut, statut_libelle, titre, type_procedure, updated_at
    confidentialite ∈ {confidentiel, interne, public}
    juridiction_degre ∈ {appel, cassation, premiere_instance}
    nature ∈ {consultatif, contentieux, precontentieux, recouvrement}
    ...
    statut ∈ {appel, audience_programmee, clos_desistement, clos_gagne, clos_perdu, clos_transaction, en_delibere, execution, instruction, jugement_rendu, ouvert}
    type_procedure ∈ {administratif, arbitrage, civil, commercial, penal, social}
- frontend/src/api/juridiqueApi.js :: mandats -> /api/django/juridique/mandats  [MandatAvocatSerializer]
    champs: cabinet, cabinet_nom, created_at, date_mandat, dossier, heures_estimees, id, mode_facturation, montant_engage, montant_forfait, pourcentage_resultat, statut, taux_horaire, updated_at
    mode_facturation ∈ {forfait, horaire, resultat}
    statut ∈ {actif, brouillon, clos, en_approbation}
- frontend/src/api/juridiqueApi.js :: notesHonoraires -> /api/django/juridique/notes-honoraires  [NoteHonorairesSerializer]
    champs: created_at, date_facture, description, id, mandat, montant_ht, montant_ttc, piece_jointe_key, reference, statut, tva, updated_at
    statut ∈ {payee, recue, validee}
- frontend/src/api/juridiqueApi.js :: remove -> /api/django/juridique/dossiers/<>  [DossierJuridiqueSerializer]
    champs: budget_alloue, confidentialite, created_at, date_ouverture, id, juridiction_degre, juridiction_nom, juridiction_ville, montant_en_jeu, montant_risque_estime, nature, nature_libelle, notre_position, partie_adverse_nom, probabilite_risque, provision_comptable_id, reference, reprise_provision_a_proposer, reprise_provision_proposee, reprise_provision_traitee, responsable_interne, responsable_interne_nom, resume_faits, statut, statut_libelle, titre, type_procedure, updated_at
    confidentialite ∈ {confidentiel, interne, public}
    juridiction_degre ∈ {appel, cassation, premiere_instance}
    nature ∈ {consultatif, contentieux, precontentieux, recouvrement}
    ...
    statut ∈ {appel, audience_programmee, clos_desistement, clos_gagne, clos_perdu, clos_transaction, en_delibere, execution, instruction, jugement_rendu, ouvert}
    type_procedure ∈ {administratif, arbitrage, civil, commercial, penal, social}
- frontend/src/api/juridiqueApi.js :: update -> /api/django/juridique/dossiers/<>  [DossierJuridiqueSerializer]
    champs: budget_alloue, confidentialite, created_at, date_ouverture, id, juridiction_degre, juridiction_nom, juridiction_ville, montant_en_jeu, montant_risque_estime, nature, nature_libelle, notre_position, partie_adverse_nom, probabilite_risque, provision_comptable_id, reference, reprise_provision_a_proposer, reprise_provision_proposee, reprise_provision_traitee, responsable_interne, responsable_interne_nom, resume_faits, statut, statut_libelle, titre, type_procedure, updated_at
    confidentialite ∈ {confidentiel, interne, public}
    juridiction_degre ∈ {appel, cassation, premiere_instance}
    nature ∈ {consultatif, contentieux, precontentieux, recouvrement}
...
- frontend/src/api/kbApi.js :: listVersions -> /api/django/kb/versions  [KbArticleVersionSerializer]
    champs: article, auteur, auteur_nom, contenu, contenu_structure, date_creation, id, titre, version
...
- frontend/src/api/litigesApi.js :: create -> /api/django/litiges/reclamations  [ReclamationSerializer]
    champs: audit, audit_id, bloque_relances, concurrent_devise, concurrent_nom, concurrent_prix, created_by, date_creation, description, dossier_juridique_id, gravite, gravite_display, id, montant_conteste, motif_perte, ncr, ncr_id, objet, reference, source_id, source_type, statut, statut_display, type_reclamation, type_reclamation_display
...
- frontend/src/api/mrpApi.js :: createOrdreFabrication -> /api/django/mrp/ordres-fabrication  [OrdreFabricationSerializer]
    champs: created_at, date_debut_planifiee, date_fin_planifiee, est_prototype, gamme, id, kit_ordre_assemblage, operations, priorite, produit, produit_nom, quantite, reservations, statut, stock_mouvemente, updated_at
...
- frontend/src/api/paieApi.js :: createPeriode -> /api/django/paie/periodes  [PeriodePaieSerializer]
    champs: annee, date_cloture, date_creation, date_paiement, devise, id, libelle, mois, statut, type_run
...
- frontend/src/api/reportingApi.js :: createKpiAlerte -> /api/django/reporting/kpi-alertes  [KpiAlerteSerializer]
    ...
    kpi ∈ {btp_penalites_cumulees_periode, btp_reserves_ouvertes, btp_rfi_en_retard, btp_visas_en_attente, delai_moyen_dedouanement, dso, encours_echu_total, juridique_delai_moyen_resolution, juridique_dossiers_ouverts, juridique_montant_en_jeu_total, juridique_taux_gain, taux_service_scm, valeur_stock_totale}
...
- frontend/src/api/rhApi.js :: createElementIntegration -> /api/django/rh/elements-integration  [ElementIntegrationSerializer]
    champs: acteur_type, acteur_type_display, date_creation, delai_jours, id, libelle, modele, ordre
    acteur_type ∈ {employe_lui_meme, it, manager, rh}
...
- frontend/src/api/rhApi.js :: createRattachementFonctionnel -> /api/django/rh/rattachements-fonctionnels  [RattachementFonctionnelSerializer]
    champs: date_creation, date_debut, date_fin, employe, employe_nom, id, manager_fonctionnel, manager_fonctionnel_nom, role_fonctionnel
...
- frontend/src/api/rhApi.js :: deleteModeleEvaluation -> /api/django/rh/modeles-evaluation/<>  [ModeleEvaluationSerializer]
    champs: actif, date_creation, date_modification, departement, id, nom, poste_ref, questions
- frontend/src/api/rhApi.js :: deleteRattachementFonctionnel -> /api/django/rh/rattachements-fonctionnels/<>  [RattachementFonctionnelSerializer]
    champs: date_creation, date_debut, date_fin, employe, employe_nom, id, manager_fonctionnel, manager_fonctionnel_nom, role_fonctionnel
...
- frontend/src/api/rhApi.js :: getCertifications -> /api/django/rh/certifications  [CertificationSerializer]
    champs: actif, date_creation, date_modification, date_obtention, date_validite, employe, employe_nom, id, note, organisme, type_certification, type_certification_display, valide
    type_certification ∈ {autre, caces_nacelle, conduite, harnais, secourisme_sst, travail_hauteur}
- frontend/src/api/rhApi.js :: getCheckInsOkr -> /api/django/rh/checkins-okr  [CheckInOkrSerializer]
    champs: auteur, auteur_nom, commentaire, date, date_creation, id, okr, valeurs_snapshot
...
- frontend/src/api/rhApi.js :: getCyclesRevision -> /api/django/rh/cycles-revision  [CycleRevisionSalarialeSerializer]
    champs: date_creation, date_debut, date_effet, date_fin, enveloppe_totale_pct, id, libelle, periode, statut, statut_display
    statut ∈ {brouillon, calibration, clos, ouvert}
...
- frontend/src/api/rhApi.js :: getElementsSortie -> /api/django/rh/elements-sortie  [ElementSortieSerializer]
    champs: acteur_type, acteur_type_display, assigne_a, assigne_a_nom, date_creation, date_recuperation, echeance, employe, en_retard, id, libelle, note, recupere, type_element, type_element_display
    acteur_type ∈ {employe_lui_meme, it, manager, rh}
...
- frontend/src/api/rhApi.js :: getPromessesEmbauche -> /api/django/rh/promesses-embauche  [PromesseEmbaucheSerializer]
    ...
    statut ∈ {envoyee, expiree, signee}
    type_contrat ∈ {anapec, cdd, cdi, interim, stage}
- frontend/src/api/rhApi.js :: getRattachementsFonctionnels -> /api/django/rh/rattachements-fonctionnels  [RattachementFonctionnelSerializer]
    champs: date_creation, date_debut, date_fin, employe, employe_nom, id, manager_fonctionnel, manager_fonctionnel_nom, role_fonctionnel
...
- frontend/src/api/rhApi.js :: updateElementIntegrationEmploye -> /api/django/rh/elements-integration-employe/<>  [ElementIntegrationEmployeSerializer]
    champs: acteur_type, acteur_type_display, assigne_a, assigne_a_nom, date, date_creation, echeance, employe, en_retard, fait, fait_par, id, libelle, ordre
    acteur_type ∈ {employe_lui_meme, it, manager, rh}
...
- frontend/src/api/rhApi.js :: updatePrimeAttribuee -> /api/django/rh/primes-attribuees/<>  [PrimeAttribueeSerializer]
    champs: annee, date_creation, date_modification, employe, employe_nom, id, mois, montant, motif, statut, statut_display, type_prime, type_prime_libelle
    statut ∈ {payee, proposee, validee}
- frontend/src/api/rhApi.js :: updateRattachementFonctionnel -> /api/django/rh/rattachements-fonctionnels/<>  [RattachementFonctionnelSerializer]
    champs: date_creation, date_debut, date_fin, employe, employe_nom, id, manager_fonctionnel, manager_fonctionnel_nom, role_fonctionnel
