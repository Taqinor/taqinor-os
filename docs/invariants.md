...
3. **TVA-CHAIN** — la chaîne Sous-total HT → Remise → Total HT → TVA → Total
   ...
   `apps/ventes/tests/test_quote_engine_formats.py::TestPdfFormats4::test_tva_note_matches_applied_math`
...
4. **TOTALS-RECONCILE** — les compartiments à taux de TVA mixtes (10 %
   ...
   `apps/ventes/tests/test_quote_engine_formats.py::TestPdfFormats3::test_mixed_rates_buckets_reconcile_to_the_centime`
...
7. **NO-PRIX-ACHAT-CLIENT-FACING** — `Produit.prix_achat` (indicateur de
   ...
   `apps/ventes/tests/test_quote_engine_formats.py::TestPdfFormats4::test_buy_prices_never_in_pdf_html`
