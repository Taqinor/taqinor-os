...
- [x] FE-XSAL6 — (already present — WIR282, vérifié 06/09/2026, 9/9 vitest verts) a "Plans de commission" screen under parametres. DÉBLOQUÉ (WIR281, 2026-08-26) : le backend expose désormais `PlanCommissionViewSet` (`/ventes/plans-commission/` + action `resoudre/?owner=`, endpoint gaté `prix_achat_voir` — GARDE MARGE : aucun montant de marge ni prix d'achat servi), et le contrat partagé vit dans `apps/ventes/contract_samples/plan_commission.json` (PACT10 : le mock de l'écran en DÉRIVE, il ne l'invente pas). Reste hors périmètre WIR281 : la consommation par `reporting/insights.py` (lane reporting). (@lane: frontend/ventes) (@after: WIR281)
