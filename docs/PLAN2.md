...
- 2026-07-11 — **PLAN2 wave (VX34/VX79/VX81).** VX34 Login tokenisé (OKLCH, icônes lucide, reduced-motion). VX79 deep-links internes + « Copier le lien » (Chantiers/SAV/Devis, distinct du lien public rule #4). VX81 noms de fichiers d'export horodatés `base_societe_date` sur 9 exports.
