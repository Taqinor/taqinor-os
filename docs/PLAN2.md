...
- [x] ODY15 — **Passe CRM** (leads, clients, activités, territoires, carte). **Done =** module.config complet (zéro route orpheline vs router/index.jsx), cockpit digne, icône/accent/description FR, nav ≤2 niveaux, tests nav de l'app verts. Files: frontend/src/features/crm/module.config.jsx, frontend/src/pages/crm/, frontend/src/pages/CartePage.jsx. (ROUTINE — M, sonnet) (@lane: frontend/app-crm) (@after: ODY4)
