...
- 2026-07-11 — **PLAN2 wave (VX199/VX83/VX53), incl. 2 re-fixes.** VX199 AUTH: accepter/emettre exigent la permission `ventes_valider` (routage par code exact, plus le laxiste is_responsable/ERR4) — re-corrigé après échec CI. VX83 « Ma file » file de travail unifiée, reconstruite ADDITIVEMENT (ZSAL1/QX25/P167 préservés, node --test 8/0) après régression. VX53 compat hover (@media hover:hover sur 68 règles), dvh, images lazy hors-écran, toasts de copie.
