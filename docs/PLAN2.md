...
- 2026-07-11 — **PLAN2 drain wave (VX76/VX199/VX157/VX96/VX83/VX59/VX32 + VX99 partial), 8 lanes.** VX76 email HTML brandé (wrapper logo/pied), VX199 AUTH (accepter/emettre exigent `ventes_valider`), VX157 UI dashboards/monitoring tokenisés, VX96 Lead soft-delete réversible (+crm 0054/0055), VX83 « Ma file » file de travail cross-module unifiée (records agrégateur + selectors crm/notifications), VX59 fuite de chemin absolu corrigée dans le nommage de chunk roof-tool (vite), VX32 CartePage tokenisée + tuiles carte dark-mode. VX99 notifications d'approbation câblées pour installations.DemandeAchat + ged.DemandeApprobation (2/3) ; contrats.EtapeApprobation reste bloqué (bulk_create n'émet pas post_save).
