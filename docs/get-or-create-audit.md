...
| `backend/django_core/apps/ventes/services.py:6788` | get_or_create | Produit.objects | company, nom |
| `backend/django_core/apps/ventes/services.py:8158` | get_or_create | Produit.objects | company, sku |
