...
| `backend/django_core/apps/ventes/services.py:6744` | get_or_create | Produit.objects | company, nom |
| `backend/django_core/apps/ventes/services.py:8114` | get_or_create | Produit.objects | company, sku |
