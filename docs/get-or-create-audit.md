...
| `backend/django_core/apps/contrats/services.py:4576` | update_or_create | CompteurUsage.objects | cible_id, code_compteur, company, periode_debut, periode_fin, type_cible |
| `backend/django_core/apps/contrats/services.py:5001` | get_or_create | EtapeDunningLog.objects | company, contrat, etape |
