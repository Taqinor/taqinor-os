...
| `backend/django_core/apps/crm/services.py:9642` | get_or_create | Playbook.objects | company, nom |
| `backend/django_core/apps/crm/services.py:9649` | get_or_create | PlaybookEtape.objects | playbook, stage |
| `backend/django_core/apps/crm/services.py:9651` | get_or_create | PlaybookTache.objects | etape, libelle |
| `backend/django_core/apps/crm/views.py:2588` | get_or_create | LeadTag.objects | company, nom |
| `backend/django_core/apps/crm/views.py:2602` | get_or_create | MotifPerte.objects | company, nom |
| `backend/django_core/apps/crm/views.py:2614` | get_or_create | MotifPerte.objects | company, nom |
| `backend/django_core/apps/crm/views.py:2671` | get_or_create | Canal.objects | cle, company |
