...
| `backend/django_core/apps/ventes/services.py:8474` | get_or_create | Produit.objects | company, nom |
| `backend/django_core/apps/ventes/services.py:9844` | get_or_create | Produit.objects | company, sku |
