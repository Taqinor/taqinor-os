...
| `backend/django_core/apps/crm/services.py:6547` | get_or_create | MessageTemplate.objects | company, nom |
...
| `backend/django_core/apps/parametres/models_relance.py:255` | get_or_create | cls.objects | cadence, company, ordre |
