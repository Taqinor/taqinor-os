...
| `backend/django_core/apps/cpq/views.py:248` | get_or_create | ParametresCPQ.objects | company |
| `backend/django_core/apps/cpq/views.py:574` | update_or_create | ReponseConfigurateur.objects | question, session |
