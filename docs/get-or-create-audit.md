...
| `backend/django_core/apps/cpq/views.py:272` | get_or_create | ParametresCPQ.objects | company |
| `backend/django_core/apps/cpq/views.py:632` | update_or_create | ReponseConfigurateur.objects | question, session |
