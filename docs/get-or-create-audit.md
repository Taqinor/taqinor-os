...
| `backend/django_core/apps/contrats/services.py:4551` | update_or_create | CompteurUsage.objects | cible_id, code_compteur, company, periode_debut, periode_fin, type_cible |
| `backend/django_core/apps/contrats/services.py:4976` | get_or_create | EtapeDunningLog.objects | company, contrat, etape |
...
| `backend/django_core/apps/sav/services.py:1310` | get_or_create | TicketFollower.objects | company, ticket, user |
