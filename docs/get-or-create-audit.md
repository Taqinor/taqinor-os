...
| `backend/django_core/apps/ventes/services.py:8362` | get_or_create | Produit.objects | company, nom |
| `backend/django_core/apps/ventes/services.py:9732` | get_or_create | Produit.objects | company, sku |
