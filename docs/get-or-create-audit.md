...
| `backend/django_core/apps/ventes/services.py:8448` | get_or_create | Produit.objects | company, nom |
| `backend/django_core/apps/ventes/services.py:9818` | get_or_create | Produit.objects | company, sku |
