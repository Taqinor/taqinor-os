...
| `backend/django_core/apps/crm/views.py:1590` | get_or_create | MotifPerte.objects | company, nom |
| `backend/django_core/apps/crm/views.py:1642` | get_or_create | Canal.objects | cle, company |
...
| `backend/django_core/apps/stock/management/commands/seed_catalogue.py:1313` | get_or_create | Categorie.objects | company, nom |
| `backend/django_core/apps/stock/management/commands/seed_catalogue.py:1601` | get_or_create | Categorie.objects | company, nom |
...
| `backend/django_core/apps/ventes/services.py:6393` | get_or_create | Produit.objects | company, nom |
| `backend/django_core/apps/ventes/services.py:7763` | get_or_create | Produit.objects | company, sku |
