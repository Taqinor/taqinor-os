...
| `backend/django_core/apps/crm/services.py:3905` | get_or_create | MessageTemplate.objects | company, nom |
...
| `backend/django_core/apps/ventes/services.py:7505` | get_or_create | Produit.objects | company, nom |
| `backend/django_core/apps/ventes/services.py:8875` | get_or_create | Produit.objects | company, sku |
