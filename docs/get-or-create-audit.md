...
| `backend/django_core/apps/ventes/services.py:346` | get_or_create | ParametresGammes.objects | company |
| `backend/django_core/apps/ventes/services.py:10328` | get_or_create | Produit.objects | company, sku |
