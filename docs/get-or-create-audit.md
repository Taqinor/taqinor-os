...
| `backend/django_core/apps/ventes/services.py:5099` | get_or_create | Produit.objects | company, nom |
| `backend/django_core/apps/ventes/services.py:6469` | get_or_create | Produit.objects | company, sku |
