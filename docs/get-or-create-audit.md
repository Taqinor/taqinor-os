...
| `backend/django_core/apps/stock/management/commands/seed_catalogue.py:1317` | get_or_create | Categorie.objects | company, nom |
| `backend/django_core/apps/stock/management/commands/seed_catalogue.py:1626` | get_or_create | Categorie.objects | company, nom |
...
| `backend/django_core/apps/ventes/services.py:6477` | get_or_create | Produit.objects | company, nom |
| `backend/django_core/apps/ventes/services.py:7847` | get_or_create | Produit.objects | company, sku |
