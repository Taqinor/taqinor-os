...
| `backend/django_core/apps/crm/services.py:6214` | get_or_create | MessageTemplate.objects | company, nom |
...
| `backend/django_core/apps/stock/management/commands/seed_catalogue.py:1641` | get_or_create | Categorie.objects | company, nom |
| `backend/django_core/apps/stock/management/commands/seed_catalogue.py:1979` | get_or_create | Categorie.objects | company, nom |
| `backend/django_core/apps/stock/models.py:526` | get_or_create | cls.objects | company |
