...
| `backend/django_core/apps/ventes/services.py:4277` | get_or_create | Produit.objects | company, nom |
| `backend/django_core/apps/ventes/services.py:5646` | get_or_create | Produit.objects | company, sku |
