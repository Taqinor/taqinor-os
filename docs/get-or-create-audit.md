...
| `backend/django_core/apps/crm/services.py:3804` | get_or_create | MessageTemplate.objects | company, nom |
...
| `backend/django_core/apps/stock/management/commands/seed_catalogue.py:978` | get_or_create | Categorie.objects | company, nom |
| `backend/django_core/apps/stock/management/commands/seed_catalogue.py:1247` | get_or_create | Categorie.objects | company, nom |
...
| `backend/django_core/apps/ventes/services.py:4828` | get_or_create | Produit.objects | company, nom |
| `backend/django_core/apps/ventes/services.py:6198` | get_or_create | Produit.objects | company, sku |
