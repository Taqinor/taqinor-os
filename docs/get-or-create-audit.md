...
| `backend/django_core/apps/ventes/services.py:6274` | get_or_create | Produit.objects | company, nom |
| `backend/django_core/apps/ventes/services.py:7644` | get_or_create | Produit.objects | company, sku |
