...
| `backend/django_core/apps/crm/views.py:1583` | get_or_create | MotifPerte.objects | company, nom |
| `backend/django_core/apps/crm/views.py:1635` | get_or_create | Canal.objects | cle, company |
...
| `backend/django_core/apps/parametres/models_tariff.py:153` | get_or_create | cls.objects | company |
| `backend/django_core/apps/parametres/models_tariff.py:155` | get_or_create | cls.objects | pk |
...
| `backend/django_core/apps/stock/management/commands/seed_catalogue.py:1306` | get_or_create | Categorie.objects | company, nom |
| `backend/django_core/apps/stock/management/commands/seed_catalogue.py:1606` | get_or_create | Categorie.objects | company, nom |
...
| `backend/django_core/apps/ventes/services.py:5822` | get_or_create | Produit.objects | company, nom |
| `backend/django_core/apps/ventes/services.py:7192` | get_or_create | Produit.objects | company, sku |
