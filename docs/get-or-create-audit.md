...
| `backend/django_core/apps/cpq/views.py:417` | update_or_create | ReponseConfigurateur.objects | question, session |
...
| `backend/django_core/apps/crm/views.py:1560` | get_or_create | MotifPerte.objects | company, nom |
| `backend/django_core/apps/crm/views.py:1612` | get_or_create | Canal.objects | cle, company |
...
| `backend/django_core/apps/marketing/services.py:832` | get_or_create | ParametresMarketing.objects | company |
