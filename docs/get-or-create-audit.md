...
| `backend/django_core/apps/ventes/services.py:8467` | get_or_create | Produit.objects | company, nom |
| `backend/django_core/apps/ventes/services.py:9837` | get_or_create | Produit.objects | company, sku |
