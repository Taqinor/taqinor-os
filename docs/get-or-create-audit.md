...
| `backend/django_core/apps/crm/services.py:10830` | get_or_create | Playbook.objects | company, nom |
| `backend/django_core/apps/crm/services.py:10837` | get_or_create | PlaybookEtape.objects | playbook, stage |
| `backend/django_core/apps/crm/services.py:10839` | get_or_create | PlaybookTache.objects | etape, libelle |
...
| `backend/django_core/apps/parametres/models_relance.py:550` | get_or_create | cls.objects | cadence, company, ordre |
