...
| `backend/django_core/apps/cpq/views.py:245` | get_or_create | ParametresCPQ.objects | company |
| `backend/django_core/apps/cpq/views.py:570` | update_or_create | ReponseConfigurateur.objects | question, session |
