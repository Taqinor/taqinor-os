...
| `backend/django_core/apps/ventes/services.py:6892` | get_or_create | Produit.objects | company, nom |
| `backend/django_core/apps/ventes/services.py:8262` | get_or_create | Produit.objects | company, sku |
