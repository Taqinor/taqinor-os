...
| `backend/django_core/apps/parametres/models_company.py:985` | get_or_create | cls.objects | company |
| `backend/django_core/apps/parametres/models_company.py:990` | get_or_create | cls.objects | pk |
...
| `backend/django_core/apps/parametres/models_relance.py:328` | get_or_create | cls.objects | cadence, company, ordre |
