...
| `backend/django_core/apps/ventes/services.py:8311` | get_or_create | Produit.objects | company, nom |
| `backend/django_core/apps/ventes/services.py:9681` | get_or_create | Produit.objects | company, sku |
