...
| `backend/django_core/apps/crm/services.py:8843` | get_or_create | Playbook.objects | company, nom |
| `backend/django_core/apps/crm/services.py:8850` | get_or_create | PlaybookEtape.objects | playbook, stage |
| `backend/django_core/apps/crm/services.py:8852` | get_or_create | PlaybookTache.objects | etape, libelle |
| `backend/django_core/apps/crm/views.py:2488` | get_or_create | LeadTag.objects | company, nom |
| `backend/django_core/apps/crm/views.py:2502` | get_or_create | MotifPerte.objects | company, nom |
| `backend/django_core/apps/crm/views.py:2514` | get_or_create | MotifPerte.objects | company, nom |
| `backend/django_core/apps/crm/views.py:2571` | get_or_create | Canal.objects | cle, company |
...
| `backend/django_core/apps/notifications/services.py:927` | get_or_create | AnnonceLecture.objects | annonce, utilisateur |
| `backend/django_core/apps/notifications/services.py:1015` | get_or_create | AnnonceRelance.objects | annonce, utilisateur |
| `backend/django_core/apps/notifications/services.py:1065` | get_or_create | ApprovalReminderState.objects | content_type, object_id |
| `backend/django_core/apps/notifications/services.py:1216` | update_or_create | SnoozedItem.objects | object_id, source, user |
...
| `backend/django_core/apps/parametres/models_relance.py:291` | get_or_create | cls.objects | cadence, company, ordre |
