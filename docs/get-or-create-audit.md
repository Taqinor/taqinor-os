...
| `backend/django_core/apps/crm/views.py:1664` | get_or_create | MotifPerte.objects | company, nom |
| `backend/django_core/apps/crm/views.py:1716` | get_or_create | Canal.objects | cle, company |
