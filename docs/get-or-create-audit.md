...
| `backend/django_core/apps/stock/management/commands/seed_catalogue.py:1448` | get_or_create | Categorie.objects | company, nom |
| `backend/django_core/apps/stock/management/commands/seed_catalogue.py:1757` | get_or_create | Categorie.objects | company, nom |
...
| `backend/django_core/apps/ventes/services.py:6550` | get_or_create | Produit.objects | company, nom |
| `backend/django_core/apps/ventes/services.py:7920` | get_or_create | Produit.objects | company, sku |
