...
| `backend/django_core/apps/stock/management/commands/seed_catalogue.py:1344` | get_or_create | Categorie.objects | company, nom |
| `backend/django_core/apps/stock/management/commands/seed_catalogue.py:1653` | get_or_create | Categorie.objects | company, nom |
