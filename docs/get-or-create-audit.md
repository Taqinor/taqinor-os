...
| `backend/django_core/apps/ventes/services.py:6259` | get_or_create | Produit.objects | company, nom |
| `backend/django_core/apps/ventes/services.py:7629` | get_or_create | Produit.objects | company, sku |
