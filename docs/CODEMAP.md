...
Generated from commit `4d7dbdf` on 2026-06-19 (CI: push trigger limited to main/dev + PR-run concurrency).
Structure fingerprint: 9f2d5fd10802b56977fc398d3614d4a596958c99c7572d6e821545af8ed3815f
...
├── .github/workflows/ci.yml      CI: changes(detector) + backend-lint, backend-tests, frontend-lint, stage-names, web-build-test, e2e + ci-gate(aggregate); per-job path filtering; push on main/dev only + all PRs (PR concurrency-cancel)
