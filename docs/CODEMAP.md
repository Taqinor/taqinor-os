...
Plan fingerprint: 0a951af581679b4cb04ff90c608c3a3660939b559beff3b093d1664ae1c292e1
...
this run's side, so the structure surface is `main`'s; a later planning-only run added Group R
(AG1–AG9), the registry-driven AI-assistant action backlog, then Group S (S1–S21), the internal team chat module backlog, to `docs/PLAN2.md`). This section is guarded by the
...
**Totals: 945 tasks — 129 done · 810 open · 6 blocked.** (2026-06-21: integrated origin/main; added Group Q (Q1–Q7) Devis↔Toiture-3D pipeline backend to PLAN2; web tasks W112–W118 in WEB_PLAN, outside the plan-fingerprint surface.) (2026-06-21: added 52 UI/UX look-and-feel tasks F120–P171 to PLAN2 Groups F–P — world-class "best-looking ERP" backlog; no task built, done/blocked unchanged.) (2026-06-21: added Group R AG1–AG9 — AI-assistant action-registry tasks (Django registry app + FastAPI propose→confirm + frontend cards + per-app action declarations) to PLAN2; no task built, done/blocked unchanged.) (2026-06-21: added Group S (S1-S21) — internal team chat module (apps/chat models + company-scoped membership-checked viewsets, attachments via records.storage, voice memos transcribed by self-hosted faster-whisper in FastAPI, @mentions, reactions, pinned, share-a-record card, smart-polling + Web-Push, gated WebSocket upgrade) to PLAN2; no task built, done/blocked unchanged.) (2026-06-21: added Group R AG10–AG12 — hands-free voice for the AI assistant (Groq Whisper transcription endpoint + voice chat + continuous conversation loop); no task built, done/blocked unchanged.)
