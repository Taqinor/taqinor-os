...
Generated from commit `7b73dda` on 2026-06-18.
Structure fingerprint: 1c6323b7cc0d7d3ff9718888fd46c6260a8db0331124d12006221730c77a670d
Plan fingerprint: c446b58e923b768a38e76a1c0c9bffcd15363016448ec2c09ec0f4a026184d08
...
cross-checked against `main`; completed tasks are archived verbatim in `docs/DONE.md`, so a fully-drained queue shows 0 done here. Generated from commit `7b73dda` on 2026-06-18 (plan-status refresh: 7 tasks ungated + 6 added). This
...
**Totals: 68 tasks — 10 done · 55 open · 3 blocked.**
...
- `G9` — Planificateur
- `N14` — Réservation de stock sur chantier puis consommation à « Installé » (regroupe N14 + G6)
- `N20` — Optional QR/barcode labels for stock SKUs and installed systems; printable labels…
- `N26` — Capture d'acceptation client légère sur un devis (nom saisi + date + confirmation « Bon…
...
- `N59` — Éditeur de gabarits de documents dans Paramètres pour les portions de texte éditables…
- `N60` — Conditions générales éditables + durée de validité configurable appliquées aux nouveaux…
- `N64` — Moteur tarifaire ONEE + ROI (TOUTES les valeurs en réglages éditables versionnés…
- `N65` — Hypothèses d'irradiation / productible par localisation pour estimer la production…
- `N67` — Textes de garantie éditables par produit & par catégorie dans Paramètres (imprimés sur…
...
- `N85` — Vue carte traçant leads/chantiers/systèmes installés/visites planifiées par GPS ou…
- `N86` — Extend the unified chatbot to read & act across all new objects (e.g. which chantiers à…
- `N87` — Intégration email pour envoyer les documents client & relances via un compte d'envoi…
- `N88` — Capture d'email entrant rattachant les réponses au fil client/chantier pertinent…
...
- `N105` — Capacité DGI LOCALE, BACKEND UNIQUEMENT, SILENCIEUSE (ungate partiel de G14)
- `N106` — Deux livrables additifs uniquement (ungate partiel de G3), dans le langage visuel du…
- `N107` — Importateur de leads Odoo : une
- `D2` — Quick settings
